                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('change.password') }}">
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-4 col-form-label text-md-right">{{__('change-password.actual')}}:</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-4 col-form-label text-md-right">{{__('change-password.new')}}:</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-4 col-form-label text-md-right">{{__('change-password.confirm')}}:</label>
                            <div class="col-md-6">
